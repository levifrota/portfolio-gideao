...
export function Skills() {
  const educations = [
    {
      name: 'Bacharelado em Engenharia da Computação - Universidade Federal do Ceará',
    },
    {
      name: 'Capacitação VTEX',
    },
  ];
      ...
      <div className='container mx-auto max-w-4xl p-4 py-12'>
        <div className='relative mb-4 p-4 text-center'>
          <h2 className='relative z-50 mb-2 font-bold'>
            ...
            <span className='relative font-handwriting text-4xl text-gray-800'>
              Skills
            </span>
          </h2>
          <p className='relative text-sm text-gray-700'>
            Front-End Developer | Vue.js | React.js | React Native | Node.js |
        ...
        <div className='flex flex-col gap-8 md:flex-row'>
          <div className='basis-1/2'>
            ...
            {educations.map((education, index) => (
              <div
                key={`education-${index}`}
                className='mb-2 rounded-lg bg-white p-4 test-sm font-semibold text-gray-900'
              >
                {education.name}
              </div>
            ))}
          ...
          <div className='basis-1/2'>
            ...
            <div className='grid grid-cols-1 gap-4 font-semibold md:grid-cols-2'>
              {skills.map((skill, index) => (
                ...
                >
                  <div className='flex h-14 w-13 items-center justify-center rounded-lg bg-white p-2'>
                    <img
                      src={skill.icon}
                      alt={skill.name}
                  ...
                  <div className='w-full flew-grow'>
