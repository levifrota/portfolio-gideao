  ...
  const services = [
    {
      title: 'Web',
      description:
        'Desenvolvimento de sites e sistemas web estáticos e dinâmicos com React.js, Vue.js, HTML5 e CSS3.',
  ...
  return (
    <section className='container mx-auto my-12 max-w-4xl p-4'>
      <div className='p-4 text-center'>
        <p className='text-sm font-semi-bold uppercase text-blue-600'>
